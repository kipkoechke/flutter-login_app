...
class ApprovedApplicationScreen extends StatelessWidget {
  const ApprovedApplicationScreen({super.key});
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    subtitle:
                                        Text(userApplication[index].subCounty),
                                  ),
                                  ListTile(
                                    title: const Text('Ward'),
                                    subtitle: Text(userApplication[index].ward),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    ...
                                    subtitle:
                                        Text(userApplication[index].nationalId),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    title: const Text('Institution\'s County'),
                                    subtitle: Text(userApplication[index]
                                        .institutionCounty),
                                  ),
                                  ListTile(
                                    title: const Text('Institution\'s Address'),
                                    subtitle: Text(userApplication[index]
                                        .institutionAddress),
                                  ),
                                  ListTile(
                                    ...
                                    subtitle: Text(
                                        userApplication[index].institutionName),
                                  ),
                                  ListTile(
                                    title: const Text(
                                  ...
                                  ListTile(
                                    ...
                                    subtitle:
                                        Text(userApplication[index].bankBranch),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    ...
                                    subtitle:
                                        Text(userApplication[index].fatherName),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    ...
                                    subtitle: Text(
                                        userApplication[index].ifFatherDisable),
                                  ),
                                  ListTile(
                                    title: const Text('Mother Name'),
                                    subtitle:
                                        Text(userApplication[index].motherName),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    ...
                                    subtitle: Text(
                                        userApplication[index].ifMotherDisable),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    title: const Text('Guardian Phone Number'),
                                    subtitle: Text(userApplication[index]
                                        .guardianPhoneNumber),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    title: const Text('If Guardian is Disable'),
                                    subtitle: Text(userApplication[index]
                                        .ifGuardianDisable),
                                  ),
